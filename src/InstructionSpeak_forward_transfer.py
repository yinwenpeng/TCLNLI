...
def main():
    ...
    tail_task = args.target_task#unseen_task
    test_file = '/home/tup51337/dataset/Natural-Instructions/test_tasks_csv/'+tail_task+'.csv'
